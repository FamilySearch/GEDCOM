...
| `UNCHALLENGED` | No reason to suspect the link between this child and this family has been identified. `UNCHALLENGED` is implied if this structure is not present. |
